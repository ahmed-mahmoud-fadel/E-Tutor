...
AppBar myAppBar = AppBar(
  title: const Text('E-Tutor: learn is life style'),
...
//COLORS
const Color MY_BACKGROUND_COLOR = Color(0xFFB1D0E0),
    MY_BUTTON_COLOR = Color(0xFFDADDFC),
    MY_DISABLED_BUTTON_COLOR = Color(0x40DADDFC);
...
class _MyTextState extends State<MyText> {
  ...
  Widget build(BuildContext context) {
    return Text(
      widget.text,
      style: const TextStyle(color: Color(0xFF1A374D)),
    );
  }
}
  ...
  return TextField(
    ...
    decoration: InputDecoration(
        enabledBorder: OutlineInputBorder(
            ...
            borderSide: const BorderSide(color: Color(0xFF1A374D))),
